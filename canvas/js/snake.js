...
var Jogo = {
	...
	_iniciar:function(){
		...
		document.getElementById('iniciarjogo').style.visibility = 'hidden';
	},
	_placar:function(){
		Jogo.pontos++;
	...
	_gameOver:function(){
		if(Jogo.play!='') clearInterval(Jogo.play);
		document.getElementById('iniciarjogo').style.visibility = 'visible';
	},
	_pausar:function(){
		if(Jogo.play!=''){
